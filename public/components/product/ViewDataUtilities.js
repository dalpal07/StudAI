...
import {save, selectCurrentFileEntries, selectCurrentFileHeaders, selectCurrentFileName} from "@/slices/fileSlice";
...
export default function ViewDataUtilities() {
    ...
    return (
        <ViewDataUtilitiesBox>
            ...
            <DefaultButton>
                <GrayBoldText size={"0.875rem" } onClick={() => dispatch(save({id: sub, headers: currentFileHeaders, entries: currentFileEntries, fileName: currentFileName}))}>Save changes</GrayBoldText>
            </DefaultButton>
        </ViewDataUtilitiesBox>
    )
}